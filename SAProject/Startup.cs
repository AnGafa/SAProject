    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            using (var scope = app.ApplicationServices.CreateScope())
            {
                ...
                if (!adminExists)
                {
                    var identityResult = roleManager.CreateAsync(new IdentityRole("Admin")).Result;
                }
                ...
                if (adminUserExists == null)
                {
                    ...
                    adminUserExists = userManager.FindByEmailAsync("admin@mysite.com").Result;
                    userManager.AddToRoleAsync(adminUserExists, "Admin");
                }
            }
